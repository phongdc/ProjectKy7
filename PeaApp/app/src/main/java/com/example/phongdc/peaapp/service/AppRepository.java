...
public interface AppRepository {
    void getAttendence(Context context,String token,String to_date, String from_date, int emp_id, CallBackData<List<Attendance>> callBackData);
    void getAttendenceStatus(Context context,String token,String to_date, String from_date, int emp_id, CallBackData<List<Status>> callBackData);
